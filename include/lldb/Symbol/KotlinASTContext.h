...
#ifndef liblldb_KotlinASTContext_h_
#define liblldb_KotlinASTContext_h_
// C Includes
// C++ Includes
...
class KotlinASTContext:public TypeSystem {
public:
    class KotlinType;
    typedef std::map<ConstString, std::unique_ptr<KotlinType>> KotlinTypeMap;

    explicit KotlinASTContext(const ArchSpec &arch);
    ~KotlinASTContext() override;
    //------------------------------------------------------------------
...
#endif //liblldb_KotlinASTContext_h_
